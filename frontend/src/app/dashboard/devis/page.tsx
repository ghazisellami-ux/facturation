...
import { FiPlus, FiSearch, FiTrash2, FiFileText, FiArrowRight, FiX, FiDownload, FiCode } from 'react-icons/fi';
...
export default function DevisPage() {
  ...
  const load = () => {
    Promise.all([
      invoicesAPI.list({ invoice_type: 'devis', search: search || undefined }),
